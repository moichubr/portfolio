...
const {t} = useTranslation("global")
  ...
  return (
    <div className="md:grid md:grid-cols-2 dark:dark-bg md:max-h-screen lg:grid lg:grid-cols-2 xl:grid xl:grid-cols-2 flex flex-col h-auto lg:max-h-screen xl:max-h-screen w-full">
      <section className="lg:col-span-1 md:col-span-1 xl:col-span-1 lg:order-1 xl:order-1 flex flex-col relative sm:p-4 md:p-0 lg:p-4 justify-end sm:pb-[20%] md:pb-[40%] lg:pb-[15%] md:ml-[10%] lg:ml-40 xl:ml-40 h-[100vh] ">
        ...
        <p className="animate-fade-left animate-duration-[2000ms] dark:text-gray-500 text-gray-900 poppins-regular tracking-wide lg:mt-16 md:mt-16 mt-12 text-sm lg:text-md xl:text-md w-full md:max-w-full sm:max-w-[85%]">
          {t("about.description")}
        </p>
       <RrssButtons />
      </section>

      <div className="dark:hidden max-h-screen max-w-full hidden md:block lg:col-span-1 xl:col-span-1 md:col-span-1 relative bottom-0 lg:order-2 xl:order-2 md:order-2 lg:pb-24">
        {/* Imagen de fondo */}
