...
<section id="about" class="py-8 md:py-16 lg:py-2">
  <div class="container mx-auto">
    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 lg:w-full items-center">
      ...
      <p class="text-white font-semibold text-4xl sm:text-5xl md:text-5xl lg:text-3xl">Welcome!</p>
<p class="text-indigo-950 font-bold text-5xl sm:text-6xl md:text-6xl lg:text-6xl mt-2">I'm Moira Brun</p>
<p class="text-white font-light text-xl sm:text-2xl md:text-2xl lg:text-xl mt-2">FullStack web developer</p>
<p class="text-white font-light md:text-lg lg:text-base mt-2">
  Committed to delivering user-centric experiences, I excel in both frontend and backend development, ensuring seamless functionality and dynamic interactions applying modern web developing technologies. Eager to contribute my expertise and drive to innovative projects, I am enthusiastic about collaborating with teams that share a common goal of generating a positive impact.
</p>

        {/* <p class="text-white font-semibold sm:text-5xl md:text-5xl lg:text-3xl">Welcome!</p>
        <p class="text-indigo-950 font-bold sm:text-6xl md:text-6xl lg:text-6xl mt-2">I'm Moira Brun</p>
        <p class="text-white font-light sm:text-2xl md:text-2xl lg:text-xl mt-2">FullStack web developer</p>
        <p class="text-white font-light md:text-lg lg:text-base mt-2">
          Committed to delivering user-centric experiences, I excel in both frontend and backend development, ensuring seamless functionality and dynamic interactions applying modern web developing technologies. Eager to contribute my expertise and drive to innovative projects, I am enthusiastic about collaborating with teams that share a common goal of generating a positive impact.
        </p> */}
      ...
      <div class="text-center md:text-center md:mt-8 lg:mt-10 lg:ml-20 md:w-2/3 lg:w-full">
        <img src={profile_picture} alt="Moira Brun" class="w-full md:w-3/5 h-auto rounded-full mx-auto md:mx-0 md:mt-16"/>
      </div>
    </div>
  </div>
</section>
